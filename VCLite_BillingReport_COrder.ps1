...
================================================================ */
var CSV_HEADERS=["#","Catalog","Desktop Group","Machine","User Name","Full Name","UPN",
  "Start Date","End Date","Duration","OS",
  "Client Name","Client Ver","Client IP","Public IP",
  "Country","City","ISP","Connected Via Host","Connected Via IP",
  "Launched Via Host","Launched Via IP","Platform","Protocol"];
var CSV_KEYS=["CatalogName","DesktopGroupName","MachineName","UserName","FullName","UserUPN",
  "StartDate","EndDate","_durLabel","MachineOS",
