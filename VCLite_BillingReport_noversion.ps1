...
/* ================================================================
   ...
   TEMPLATE FILE --- no hardcoded data.
   PS1 injects CITRIX_DATA_PLACEHOLDER_JSON_ARRAY and
   CITRIX_META_PLACEHOLDER_JSON_OBJECT at runtime.
   Supports 2M+ records via virtual scroll + streaming CSV.
================================================================ */
:root{
  --brand    :rgb(216,0,116);
